...
import static seedu.tassist.logic.commands.CommandTestUtil.ADDRESS_DESC_BOB;
...
import static seedu.tassist.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
...
import static seedu.tassist.logic.commands.CommandTestUtil.VALID_ADDRESS_AMY;
...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_ADDRESS_DESC, Address.MESSAGE_CONSTRAINTS); // invalid tassist
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + ATTENDANCE_LIST + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FRIEND;
